...
const fields: Record<TableName, string[]> = {
  ...
  quotations: ["id", "quote_number", "title", "client_id", "deal_id", "status", "currency", "issue_date", "valid_until", "tax_rate", "discount", "notes", "created_at", "updated_at"],
  quotation_items: ["id", "quotation_id", "description", "quantity", "unit_price", "created_at", "updated_at"],
  projects: ["id", "name", "code", "client_id", "manager", "status", "start_date", "end_date", "budget", "currency", "progress", "description", "created_at", "updated_at"],
  bids: ["id", "reference", "title", "buyer", "client_id", "status", "closing_date", "submission_date", "value", "currency", "bond_amount", "notes", "created_at", "updated_at"],
  cost_sheets: ["id", "name", "client_id", "quotation_id", "bid_id", "project_id", "status", "currency", "notes", "created_at", "updated_at"],
  cost_sheet_items: ["id", "cost_sheet_id", "category", "description", "quantity", "unit_cost", "markup_percent", "created_at", "updated_at"],
  jobs: ["id", "title", "client_id", "project_id", "job_type", "assignee", "priority", "status", "scheduled_date", "completed_at", "notes", "created_at", "updated_at"],
  tasks: ["id", "title", "entity_type", "entity_id", "assignee", "priority", "status", "due_date", "notes", "created_at", "updated_at"],
  suppliers: ["id", "name", "contact_name", "email", "phone", "category", "notes", "created_at", "updated_at"],
  purchase_orders: ["id", "po_number", "supplier_id", "project_id", "status", "order_date", "expected_date", "currency", "notes", "created_at", "updated_at"],
  purchase_order_items: ["id", "purchase_order_id", "description", "quantity", "unit_price", "received_quantity", "created_at", "updated_at"],
  prequalifications: ["id", "reference", "buyer", "category", "submission_type", "status", "submitted_date", "valid_until", "outcome", "notes", "created_at", "updated_at"],
  requests: ["id", "reference", "title", "issuer", "client_id", "request_type", "status", "received_date", "due_date", "value", "currency", "scope", "created_at", "updated_at"],
  marketing_activities: ["id", "name", "channel", "status", "start_date", "end_date", "budget", "spend", "leads", "currency", "notes", "created_at", "updated_at"],
  documents: ["id", "title", "category", "entity_type", "entity_id", "owner", "version", "file_url", "issue_date", "expiry_date", "notes", "created_at", "updated_at"],
  vacancies: ["id", "title", "department", "employment_type", "status", "openings", "location", "closing_date", "description", "created_at", "updated_at"],
  applicants: ["id", "vacancy_id", "full_name", "email", "phone", "stage", "rating", "resume_url", "notes", "created_at", "updated_at"],
  employees: ["id", "employee_number", "full_name", "email", "phone", "job_title", "department", "employment_type", "status", "start_date", "end_date", "base_salary", "currency", "notes", "created_at", "updated_at"],
  leave_requests: ["id", "employee_id", "leave_type", "start_date", "end_date", "days", "status", "reason", "created_at", "updated_at"],
  payroll_runs: ["id", "period", "pay_date", "status", "currency", "notes", "created_at", "updated_at"],
  payroll_items: ["id", "payroll_run_id", "employee_id", "gross", "allowances", "deductions", "tax", "net", "created_at", "updated_at"],
  invoices: ["id", "invoice_number", "client_id", "quotation_id", "project_id", "status", "issue_date", "due_date", "amount", "tax", "paid_amount", "currency", "notes", "created_at", "updated_at"],
  expenses: ["id", "description", "category", "vendor", "amount", "currency", "expense_date", "project_id", "status", "notes", "created_at", "updated_at"],
  payments: ["id", "invoice_id", "amount", "currency", "paid_at", "method", "reference", "created_at", "updated_at"],
};
