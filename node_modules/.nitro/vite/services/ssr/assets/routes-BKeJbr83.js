...
import { ArrowUpRight, BarChart3, Bell, ChevronDown, CircleHelp, ContactRound, FileUp, Inbox, LayoutDashboard, Mail, Menu, MoreHorizontal, Plus, Search, Send, Settings, Sparkles, Target, Users, X } from "lucide-react";
...
function Index() {
	...
	const filtered = useMemo(() => campaigns.filter((c) => `${c.name} ${c.audience}`.toLowerCase().includes(query.toLowerCase())), [query]);
				...
				children: [
					...
					/* @__PURE__ */ jsxs("nav", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							children: "Workspace"
						}), nav.map(([label, Icon]) => /* @__PURE__ */ jsxs("button", {
							onClick: () => {
								setActive(label);
								setMobileOpen(false);
							},
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Settings, { className: "size-[18px]" }), "Settings"]
						}), /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx(ChevronDown, { className: "size-4 text-slate-400" })
							]
						})]
					})
				]
				...
				children: [/* @__PURE__ */ jsxs("header", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Search, { className: "absolute left-3 top-1/2 size-4 -translate-y-1/2 text-slate-400" }), /* @__PURE__ */ jsx("input", {
								value: query,
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("button", {
									...
									children: /* @__PURE__ */ jsx(CircleHelp, { className: "size-5" })
								}),
								/* @__PURE__ */ jsxs("button", {
									"aria-label": "Notifications",
									className: "relative rounded-lg p-2.5 text-slate-500 hover:bg-slate-100",
									children: [/* @__PURE__ */ jsx(Bell, { className: "size-5" }), /* @__PURE__ */ jsx("span", { className: "absolute right-2 top-2 size-2 rounded-full border-2 border-white bg-rose-500" })]
								}),
								/* @__PURE__ */ jsxs("button", {
					...
					children: [
						/* @__PURE__ */ jsxs("section", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [
								...
								children: [/* @__PURE__ */ jsx(FileUp, { className: "size-4" }), "Import prospects"]
							})]
						}),
						/* @__PURE__ */ jsx("section", {
							...
							].map(([label, value, detail, Icon]) => /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												/* @__PURE__ */ jsx("td", {
													...
													children: /* @__PURE__ */ jsx("button", {
														...
														children: /* @__PURE__ */ jsx(MoreHorizontal, { className: "size-4 text-slate-400" })
													})
												})
											]
										}, c.name)) })]
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", {
										...
										].map(([initials, action, campaign, time]) => /* @__PURE__ */ jsxs("div", {
									...
									/* @__PURE__ */ jsxs("button", {
										...
										children: ["Open inbox ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "size-4" })]
									})
								]
							})]
						}),
						/* @__PURE__ */ jsxs("section", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(Sparkles, { className: "size-5" })
								...
								children: ["Create campaign ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "size-4" })]
							})]
						})
					]
				})]
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("label", {
									...
									children: ["Campaign name", /* @__PURE__ */ jsx("input", {
										autoFocus: true,
								...
								/* @__PURE__ */ jsxs("label", {
									className: "block text-sm font-semibold",
									children: ["Email subject", /* @__PURE__ */ jsx("input", {
										className: "mt-2 h-11 w-full rounded-xl border border-slate-200 px-3 font-normal outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-50",
								...
								/* @__PURE__ */ jsxs("label", {
									className: "block text-sm font-semibold",
									children: ["Audience", /* @__PURE__ */ jsxs("select", {
										className: "mt-2 h-11 w-full rounded-xl border border-slate-200 bg-white px-3 font-normal outline-none",
										children: [
											/* @__PURE__ */ jsx("option", { children: "All prospects" }),
											/* @__PURE__ */ jsx("option", { children: "New prospects" }),
											/* @__PURE__ */ jsx("option", { children: "Warm prospects" })
										]
									})]
								})
							]
