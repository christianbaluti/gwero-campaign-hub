...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-DoeSzyyi.js";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Bze0j7VO.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DDg9_29c.js"),
		import("./start-CVCKJ5ZD.js"),
